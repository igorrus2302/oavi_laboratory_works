...
* **SNR до обработки:** `~31,05 dB`
* **SNR после обработки:** `~30,90 dB`
...
Также имеет место быть такой вариант, что исходный сигнал был изначально достаточно чистым, из чего следует, что подавлять практически нечего.
...
1. `t = [8.6; 8.7] c`, `f = [220; 270] Гц`, `E ≈ 0.016`
2. `t = [18.4; 18.5] c`, `f = [220; 270] Гц`, `E ≈ 0.016`
3. `t = [5.2; 5.3] c`, `f = [220; 270] Гц`, `E ≈ 0.016`
4. `t = [22.0; 22.1] c`, `f = [220; 270] Гц`, `E ≈ 0.015`
5. `t = [6.3; 6.4] c`, `f = [200; 250] Гц`, `E ≈ 0.015`
